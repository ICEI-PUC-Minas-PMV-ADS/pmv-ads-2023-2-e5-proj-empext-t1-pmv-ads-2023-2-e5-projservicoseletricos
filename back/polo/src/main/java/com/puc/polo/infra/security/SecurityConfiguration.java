package com.puc.polo.infra.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/api/imagens/*").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/imagens/produto/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/produtos").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/produtos/filtrar/*").permitAll()
